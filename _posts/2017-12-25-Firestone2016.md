...
Just to lay out what top-down factors influencing perception may entail, here are two examples. Note that the authors define "top-down" as a sort of cognitive penetrability -- it is not enough that <i>input</i> is changed (e.g., closing eyes changes perception), the process of input to output has to be changed.

1. After completing a racial categorization task, Levin & Banaji (2006) reported that the perceived lightness of faces was altered.
...
<img src = "https://puu.sh/yNa4i/ab1c2e31cf.png">
...
<img src = "https://puu.sh/yTwKd/c553527574.png">
